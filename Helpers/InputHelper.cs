...
namespace CcNet.Utils.Helpers
{
    ...
    public static class InputHelper
    {
        ...
        private readonly static Dictionary<TextInputMode, Regex> InputCheckRegexes =
            ...
            {
                [TextInputMode.Characters] = RgxCharacters,
                [TextInputMode.Digitals] = RgxDigitals,
                [TextInputMode.UnsignedInt] = RgxUnsignedInt,
                [TextInputMode.SignedInt] = RgxSignedInt_Input,
                [TextInputMode.UnsignedFloat] = RgxUnsignedFloat_Input,
                [TextInputMode.SignedFloat] = RgxSignedFloat_Input,
            };
        ...
        private readonly static Dictionary<TextInputMode, Regex> FinalCheckRegexes =
            new Dictionary<TextInputMode, Regex>()
            {
                ...
                [TextInputMode.Digitals] = RgxDigitals,
                [TextInputMode.UnsignedInt] = RgxUnsignedInt,
                [TextInputMode.SignedInt] = RgxSignedInt_Final,
                [TextInputMode.UnsignedFloat] = RgxUnsignedFloat_Final,
                [TextInputMode.SignedFloat] = RgxSignedFloat_Final,
            };
