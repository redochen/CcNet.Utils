...
namespace CcNet.Utils.Extensions
{
    ...
    public static class ObjectExtension
    {
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public static decimal ToDecimal(this object obj, decimal defaultValue = 0.0M)
            => obj.TryDecimal() ?? defaultValue;
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public static double ToDouble(this object obj, double defaultValue = 0.0F)
            => obj.TryDouble() ?? defaultValue;
        ...
        public static T CopyValue<T>(this T self, T other, bool inherit = false, bool includeStatic = false)
            where T : class, new()
            => self.CopyValueEx(other, inherit: inherit, includeStatic: includeStatic);
        ...
        /// <returns></returns>
        public static object Invoke(this object obj, string method)
            => obj.Invoke(method, parameters: null, inherit: true, types: null);
        ...
        /// <returns></returns>
        public static object Invoke(this object obj, string method, object[] parameters)
            => obj.Invoke(method, parameters: parameters, inherit: true, types: null);
        ...
        /// <returns></returns>
        public static object Invoke(this object obj, string method, object[] parameters, Type[] types)
            => obj.Invoke(method, parameters: parameters, inherit: true, types: types);
        ...
        /// <returns></returns>
        public static object InvokeGeneric(this object obj, string method, object[] parameters, params Type[] genericTypes)
            => obj.InvokeGeneric(method, parameters: parameters, inherit: true, types: null, genericTypes: genericTypes);
        ...
        /// <param name="pathChar">路径字符</param>
        /// <returns></returns>
        public static bool HasFieldOrProperity(this object obj, string name, char pathChar = '.')
            => obj.GetFieldOrProperity(name, inherit: true, includeStatic: true, pathChar: pathChar) != null;
        ...
        public static MemberInfo GetFieldOrProperity(this object obj, string name,
            bool inherit, bool includeStatic, char pathChar = '.')
            => obj.GetMember(name, out object parentObj, inherit: inherit, includeStatic: includeStatic,
        ...
        /// <param name="includeStatic">是否包含静态的成员</param>
        /// <returns></returns>
        public static IEnumerable<MemberInfo> GetFieldsAndProperities(this object obj, bool inherit, bool includeStatic)
            => obj.GetMembers(inherit: inherit, includeStatic: includeStatic,
        ...
        /// 成员信息缓存
        /// </summary>
        private static ConcurrentDictionary<string, IEnumerable<MemberInfo>> MembersCache
            = new ConcurrentDictionary<string, IEnumerable<MemberInfo>>();
        ...
        public static TAttribute GetAttribute<TAttribute>(this MemberInfo member, bool inherit)
            ...
            => member.GetAttributes<TAttribute>(inherit)?.FirstOrDefault();
    ...
    public static class InstanceExtension
    {
        ...
        /// 特殊类型的实例创建器
        /// </summary>
        private static readonly Dictionary<string, Func<object>> SpecialTypeNameCreaters
        ...
        /// 特殊类型的实例创建器
        /// </summary>
        private static readonly Dictionary<Type, Func<Type, object>> SpecialTypeCreaters
        ...
        /// 特殊类型的实例复制器
        /// </summary>
        private static readonly Dictionary<string, Func<object, object>> SpecialTypeNameCloner
        ...
        /// 特殊类型的实例复制器
        /// </summary>
        private static readonly Dictionary<Type, Func<object, object>> SpecialTypeCloner
