...
namespace CcNet.Utils.Extensions
{
    ...
    public static class IoExtension
    {
        ...
        /// <returns></returns>
        public static bool IsFile(this string path, out string error)
        {
            error = null;
        ...
        /// <param name="error">错误信息</param>
        /// <returns></returns>
        public static bool IsDirectory(this string path, out string error)
        {
            error = null;
        ...
        /// <returns></returns>
        public static List<FileInfo> GetFiles(this string path, out string error, bool searchSubFolderFiles = false)
        {
            List<FileInfo> files = null;
            List<DirectoryInfo> folders = null;

            error = path.GetFilesAndFolders(ref files, ref folders,
        ...
        /// <returns></returns>
        public static List<DirectoryInfo> GetFolders(this string path, out string error, bool searchSubFolders = false)
        {
            List<FileInfo> files = null;
            List<DirectoryInfo> folders = null;
        ...
        public static string GetFilesAndFolders(this string path, ref List<FileInfo> foundFiles, ref List<DirectoryInfo> foundFolders,
            ...
            Func<FileSystemInfo/*info*/, bool/*ok*/> checkPath = null)
        {
            ...
            foreach (var folder in folders)
            {
                ...
                var err = folder.FullName.GetFilesAndFolders(ref foundFiles, ref foundFolders,
        ...
        /// <param name="error">错误信息</param>
        /// <returns></returns>
        public static string GetFileDir(this string file, out string error)
        {
            error = string.Empty;
        ...
        /// <param name="error">错误信息</param>
        /// <returns></returns>
        public static string PathRemoveFileExtension(this string file, out string error)
        {
            error = string.Empty;
        ...
        /// <param name="error">错误信息</param>
        /// <returns></returns>
        public static long GetFileSize(this string file, out string error)
        {
            error = string.Empty;
        ...
        /// <param name="error">错误信息</param>
        /// <returns></returns>
        public static string GetFileVersion(this string file, out string error)
            => file.GetFileVersion(out error, out (int, int, int, int) versionsPart);
        ...
        public static void EnsureDirectory(this string path, bool isFile)
        {
            if (!path.IsValid())
            {
                return;
        ...
        /// <returns>错误信息</returns>
        public static string ClearDirectory(this string path, bool deleteAllFiles = true, bool deleteAllFolders = true)
        {
            try
            {
                if (!path.IsValid())
                ...
                var error = path.GetFilesAndFolders(ref files, ref folders, searchFiles: true,
        ...
        /// <returns></returns>
        public static string WriteFile(this string filePath, string content, bool append = false)
        {
            if (!filePath.IsValid())
            {
                return "文件路径不能为空";
        ...
        /// <returns></returns>
        public static string CopyOrMoveFile(this string srcFile, string dstFile, bool overwrite = true, bool moveFile = false)
        {
            try
            {
                if (!srcFile.IsValid())
                ...
                dstFile.EnsureDirectory(isFile: true);
        ...
        /// <param name="filePath">文件路径</param>
        /// <returns>返回值的字符串形式</returns>
        public static string GetFileCRC32(this string filePath)
        {
            if (!filePath.IsValid() || !File.Exists(filePath))
            {
                return string.Empty;
        ...
        /// <param name="filePath">文件路径</param>
        /// <returns></returns>
        public static string GetTempFile(this string filePath)
        {
            if (!filePath.IsValid())
            {
                return string.Empty;
