...
namespace CcNet.Utils.Extensions
{
    ...
    public static class DataTableExtension
    {
        ...
        /// <returns></returns>
        public static DataRow GetFirstRow(this DataTable table, Func<DataRow, bool> predicate = null)
            => table.Rows.FirstOrDefault(predicate);
        ...
        /// <param name="predicate">过滤方法</param>
        /// <returns></returns>
        public static DataRow GetLastRow(this DataTable table, Func<DataRow, bool> predicate = null)
            => table.Rows.LastOrDefault(predicate);
        ...
        public static void AddColumns(this DataTable table, params string[] columns)
            => table.AddColumns(columns?.ToList());
        ...
        /// <returns></returns>
        public static DataTable SelectColumns(this DataTable table, Hashtable htAliasMap = null, bool includeFields = false, params string[] fields)
            => table.SelectEx(string.Empty, htAliasMap, includeFields, fields);
        ...
        /// <param name="htAliasMap">字段别名映射关系</param>
        /// <returns></returns>
        public static DataTable SelectRows(this DataTable table, string where, Hashtable htAliasMap = null)
            => table.SelectEx(where, htAliasMap);
