...
namespace CcNet.Utils.Extensions
{
    ...
    public static class DataRowExtension
    {
        ...
        public static string GetString(this DataRow dataRow, string columnName)
            => dataRow.GetValue(columnName).ToStringEx();
        ...
        /// <param name="dataColumn">列对象</param>
        /// <returns></returns>
        public static string GetString(this DataRow dataRow, DataColumn dataColumn)
            => dataRow.GetValue(dataColumn).ToStringEx();
        ...
        public static int GetInt(this DataRow dataRow, string columnName)
            => dataRow.GetValue(columnName).ToInt();
        ...
        /// <param name="dataColumn">列对象</param>
        /// <returns></returns>
        public static int GetInt(this DataRow dataRow, DataColumn dataColumn)
            => dataRow.GetValue(dataColumn).ToInt();
        ...
        /// <param name="columnName">列名</param>
        /// <returns></returns>
        public static long GetLong(this DataRow dataRow, string columnName)
            => dataRow.GetValue(columnName).ToLong();
        ...
        /// <param name="dataColumn">列对象</param>
        /// <returns></returns>
        public static long GetLong(this DataRow dataRow, DataColumn dataColumn)
            => dataRow.GetValue(dataColumn).ToLong();
        ...
        public static double GetDouble(this DataRow dataRow, string columnName)
            => dataRow.GetValue(columnName).ToDouble();
        ...
        /// <param name="dataColumn">列对象</param>
        /// <returns></returns>
        public static double GetDouble(this DataRow dataRow, DataColumn dataColumn)
            => dataRow.GetValue(dataColumn).ToDouble();
        ...
        public static decimal GetDecimal(this DataRow dataRow, string columnName)
            => dataRow.GetValue(columnName).ToDecimal();
        ...
        /// <param name="dataColumn">列对象</param>
        /// <returns></returns>
        public static decimal GetDecimal(this DataRow dataRow, DataColumn dataColumn)
            => dataRow.GetValue(dataColumn).ToDecimal();
