...
namespace CcNet.Utils.Extensions
{
    ...
    public static class CollectionExtension
    {
        ...
        public static bool IsEmpty<T>(this IEnumerable<T> enumerable)
            => (null == enumerable || !enumerable.Any());
        ...
        /// <returns></returns>
        public static bool IsEmptyEx(this ICollection collection)
            => (null == collection || collection.Count <= 0);
        ...
        /// <returns></returns>
        public static bool ContainsEx<T>(this IEnumerable<T> enumerable, T item)
            => (!enumerable.IsEmpty() && enumerable.Contains(item));
        ...
        /// <returns></returns>
        public static bool ContainsKeyEx<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, TKey key)
